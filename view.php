                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $student)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="show.php?id=<?= $student['ID']; ?>" class="btn btn-info btn-sm">View</a>
                                                    <a href="edit.php?id=<?= $student['ID']; ?>" class="btn btn-success btn-sm">Edit</a>
													 <form action="code.php" method="POST" class="d-inline">
                                                        <button type="submit" style="background-color:Blue" name="going" value="<?=$student['ID'];?>" class="btn btn-success btn-sm">On going</button>
                                                    </form>
